...
// warning 4251: exported (dll) classes need all members to be exported as well;
// STL does not do that,
#pragma warning(disable : 4251)
// warning 26444: don't declare variables without names; Our named_handle keeps
